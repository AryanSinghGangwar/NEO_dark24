    ...
    <section class="container-fluid d-lg-none d-block" id="home_mob">
      ...
      <div class="text-center"><a href="https://t.me/EntreLearners" target="_blank"> 
        ...
        <li class="nav-item pt-3 text-center mb-3">
          ...
          <a class="btn btn-dark bg btn1 btn my-1" data-aos="fade-right" data-aos-duration="1000" href="images/NEO Brochure 25.pdf" target="_blank" role="button"> BROCHURE<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
            <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
          </svg></a>
    ...
    <section id="winners" class="winners">
      ...
      <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up" data-aos-duration="1000">
          <h4 class="congratulations-text" style="color: #ff8606; font-weight: bold;">Congratulations to all our winners for their outstanding achievement!</h4>
          <div class="winners-note" style="color: #ffffff; font-weight: bold;">These exceptional participants have demonstrated remarkable entrepreneurial skills and innovative thinking throughout the competition.</div>
        </div>
      </div>
    </section>
